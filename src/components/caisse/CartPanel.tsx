...
const SelectCustomerModal: React.FC<{
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-gray-800 p-6 rounded-lg w-96 max-w-md max-h-96 overflow-y-auto">
        <div className="flex justify-between items-center mb-4">
          <h2 className="text-xl font-bold text-white">Sélectionner un client</h2>
          <button onClick={onClose} className="text-gray-400 hover:text-white">
            <X size={24} />
          </button>
        </div>
        <div className="space-y-2">
          ...
          {customers.map((customer) => (
            <button
              ...
              className="w-full bg-gray-700 hover:bg-gray-600 text-white py-2 px-3 rounded-md text-left"
            >
  ...
  return (
    <>
      <div className="h-full flex flex-col overflow-hidden bg-gray-900">
        ...
        <div className="flex-shrink-0 p-2 border-b border-gray-800 flex justify-between items-center">
          <h2 className="text-xl font-bold text-white">Panier ({totalItems})</h2>
          {isMobile && onClose && (
            <button onClick={onClose} className="text-gray-400 hover:text-white">
              <X size={24} />
            </button>
        ...
        <div className="flex-shrink-0 p-2 border-b border-gray-800">
          ...
          >
            <div className="flex items-center space-x-1">
              ...
              <div>
                <p className="font-medium text-white">{selectedCustomer ? selectedCustomer.name : 'Ajouter un client'}</p>
                {selectedCustomer && <p className="text-sm text-gray-400">{selectedCustomer.phone}</p>}
              </div>
            </div>
        ...
        {cart.length > 0 && (
          <div className={`flex-shrink-0 p-4 border-t border-gray-800 space-y-4 ${isMobile ? 'pb-24' : ''}`}>
            <div className="space-y-2">
              ...
              <div className="flex justify-between items-center text-gray-300">
                ...
                <input 
                  ...
                  className="w-24 bg-gray-700 text-white text-right rounded-md p-1 border border-gray-600"
                />
              </div>
            ...
            <div className="grid grid-cols-3 gap-2">
              <button 
                ...
                className="bg-slate-700 hover:bg-slate-500 text-white font-semibold py-2 rounded-lg flex items-center justify-center"
              >
